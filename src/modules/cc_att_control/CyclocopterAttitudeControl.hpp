...
private:
	...
	DEFINE_PARAMETERS(
		...
		(ParamFloat<px4::params::CC_ROLLRATE_MAX>)  	_param_cc_rollrate_max,   /**< 最大滚转角速度 */
		(ParamFloat<px4::params::CC_PITCHRATE_MAX>) 	_param_cc_pitchrate_max,  /**< 最大俯仰角速度 */
		(ParamFloat<px4::params::CC_YAWRATE_MAX>)   	_param_cc_yawrate_max,    /**< 最大偏航角速度 */

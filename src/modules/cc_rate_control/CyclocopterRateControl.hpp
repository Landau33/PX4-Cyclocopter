...
private:
	...
	DEFINE_PARAMETERS(
		(ParamFloat<px4::params::CC_ROLLRATE_P>) _param_cc_rollrate_p, ///< 滚转速率 P 增益
		(ParamFloat<px4::params::CC_ROLLRATE_I>) _param_cc_rollrate_i, ///< 滚转速率 I 增益
		(ParamFloat<px4::params::CC_RR_INT_LIM>) _param_cc_rr_int_lim, ///< 滚转速率积分器限制
		(ParamFloat<px4::params::CC_ROLLRATE_D>) _param_cc_rollrate_d, ///< 滚转速率 D 增益
		(ParamFloat<px4::params::CC_ROLLRATE_FF>) _param_cc_rollrate_ff, ///< 滚转速率前馈
		(ParamFloat<px4::params::CC_ROLLRATE_K>) _param_cc_rollrate_k, ///< 滚转速率全局增益

		(ParamFloat<px4::params::CC_PITCHRATE_P>) _param_cc_pitchrate_p, ///< 俯仰速率 P 增益
		(ParamFloat<px4::params::CC_PITCHRATE_I>) _param_cc_pitchrate_i, ///< 俯仰速率 I 增益
		(ParamFloat<px4::params::CC_PR_INT_LIM>) _param_cc_pr_int_lim, ///< 俯仰速率积分器限制
		(ParamFloat<px4::params::CC_PITCHRATE_D>) _param_cc_pitchrate_d, ///< 俯仰速率 D 增益
		(ParamFloat<px4::params::CC_PITCHRATE_FF>) _param_cc_pitchrate_ff, ///< 俯仰速率前馈
		(ParamFloat<px4::params::CC_PITCHRATE_K>) _param_cc_pitchrate_k, ///< 俯仰速率全局增益

		(ParamFloat<px4::params::CC_YAWRATE_P>) _param_cc_yawrate_p, ///< 偏航速率 P 增益
		(ParamFloat<px4::params::CC_YAWRATE_I>) _param_cc_yawrate_i, ///< 偏航速率 I 增益
		(ParamFloat<px4::params::CC_YR_INT_LIM>) _param_cc_yr_int_lim, ///< 偏航速率积分器限制
		(ParamFloat<px4::params::CC_YAWRATE_D>) _param_cc_yawrate_d, ///< 偏航速率 D 增益
		(ParamFloat<px4::params::CC_YAWRATE_FF>) _param_cc_yawrate_ff, ///< 偏航速率前馈
		(ParamFloat<px4::params::CC_YAWRATE_K>) _param_cc_yawrate_k, ///< 偏航速率全局增益

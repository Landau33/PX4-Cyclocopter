...
{
	const Vector3f rate_k = Vector3f(_param_cc_rollrate_k.get(), _param_cc_pitchrate_k.get(), _param_cc_yawrate_k.get());

	// 配置速率控制参数
	_rate_control.setPidGains(
		// a.emult(b)=Vector3 [a.xb.x, a.yb.y, a.z*b.z]
		rate_k.emult(Vector3f(_param_cc_rollrate_p.get(), _param_cc_pitchrate_p.get(), _param_cc_yawrate_p.get())),
		rate_k.emult(Vector3f(_param_cc_rollrate_i.get(), _param_cc_pitchrate_i.get(), _param_cc_yawrate_i.get())),
		rate_k.emult(Vector3f(_param_cc_rollrate_d.get(), _param_cc_pitchrate_d.get(), _param_cc_yawrate_d.get())));
	_rate_control.setIntegratorLimit(Vector3f(_param_cc_rr_int_lim.get(), _param_cc_pr_int_lim.get(), _param_cc_yr_int_lim.get()));
	_rate_control.setFeedForwardGain(Vector3f(_param_cc_rollrate_ff.get(), _param_cc_pitchrate_ff.get(), _param_cc_yawrate_ff.get()));
}

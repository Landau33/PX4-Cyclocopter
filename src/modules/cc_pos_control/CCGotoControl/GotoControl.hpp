...
public:
	...
	void setParamCpcZAccMaxDown(const float param_cpc_z_acc_max_dn) { _param_cpc_z_acc_max_dn = param_cpc_z_acc_max_dn; }
	...
	void setParamCpcZVelDn(const float param_cpc_z_vel_max_dn) { _param_cpc_z_vel_max_dn = param_cpc_z_vel_max_dn; }
	void setParamCpcZVelUp(const float param_cpc_z_vel_max_up) { _param_cpc_z_vel_max_up = param_cpc_z_vel_max_up; }
	void setParamCpcYawRateMax(const float param_cpc_yawrate_max) { _param_cpc_yawrate_max = param_cpc_yawrate_max; }
	void setParamCpcYawAccMAx(const float param_cpc_yaw_acc_max) { _param_cpc_yaw_acc_max = param_cpc_yaw_acc_max; }
...
private:
	...
	float _param_cpc_z_acc_max_dn{0.f}; // 最大垂直下降加速度
	float _param_cpc_xy_vel_max{0.f}; // 水平速度最大值
	float _param_cpc_yawrate_max{0.f}; // 最大偏航速率
	float _param_cpc_yaw_acc_max{0.f}; // 最大偏航加速度
	float _param_cpc_z_vel_max_dn{0.f}; // 最大垂直下降速度
	float _param_cpc_z_vel_max_up{0.f}; // 最大垂直上升速度
